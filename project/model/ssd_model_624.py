...
def ssd_model_624():
    ...
    # defining locs
    loc_1 = layers.Conv2D(3 * 4, (3, 3), padding='same', name='1st_bbs')(BASE_MODEL.output)
    ...
    conf_1 = layers.Conv2D(3 * 2, (3, 3), padding='same', name='1st_conf')(BASE_MODEL.output)
