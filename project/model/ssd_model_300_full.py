...
def ssd_model_300(num_classes=40, reg=0.00003):
    ...
    conf_1 = layers.Conv2D(4 * num_classes, (1, 1), name='1st_conf')(conv4_3)
    conf_2 = layers.Conv2D(6 * num_classes, (1, 1), name='2nd_conf')(fc7)
    conf_3 = layers.Conv2D(6 * num_classes, (1, 1), name='3rd_conf')(conv8_2)
